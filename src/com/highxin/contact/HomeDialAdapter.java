...
//			holder.call_btn = (TextView) convertView.findViewById(R.id.call_btn);
		...
		switch (clb.getType()) {
		case 1:
			holder.call_type.setBackgroundResource(R.drawable.callin);
			break;
		case 2:
			holder.call_type.setBackgroundResource(R.drawable.callout);
			break;
		case 3:
			holder.call_type.setBackgroundResource(R.drawable.callno);
			break;
		}
